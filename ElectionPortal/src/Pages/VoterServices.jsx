...
import { getConstituancyListByDistrict, getDistrictListByState, getPolingBooth, getPolingStationEditablePdf, getPollingBoothListByConstituancy, getStateList } from '../Store/Middleware/VoterApiServices';
                                ...
                                {station.pdfs?.map((pdf, pdfIndex) => (
                                  <div key={`pdf-${pdfIndex}`} className="split-cell-row">
                                    <a
                                      ...
                                      onClick={()=>{downloadPdfWithFileSaver(pdf.url, pdf.pdf_name);}}
                                    >
                                  ...
                                  pdf.file_url || pdf.pdf_exists === true ? (
                                    ...
                                    <div key={`action-${pdfIndex}`} className="split-cell-row">
                                      <button
                                        ...
                                        onClick={() =>convertToEditablePdf(pdf.attach_id, pdf.file_name)}
                                        // onClick={(e) => onHandlePayment(e, pdf.attach_id, pdf.file_name)}
