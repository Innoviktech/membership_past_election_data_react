// This file centralizes all your API endpoints.
// NOTE: I've replaced `import.meta.env.VITE_ORIGIN` to avoid build issues in this environment.
// In your actual project, you can use your original VITE-based code.
